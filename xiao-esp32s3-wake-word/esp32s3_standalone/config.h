...
// ============================================================================
// STANDALONE OPERATION NOTES
// ============================================================================

// This configuration is optimized for standalone operation:
// - No WAV file generation or transmission
// - No PC communication protocol
// - Local inference only with Serial logging
// - LED visual feedback for detections
